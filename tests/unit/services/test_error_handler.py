"""Comprehensive tests for error_handler.py - consolidated from simple and extended tests."""
...
class TestErrorType:
    ...
    def test_error_type_enum_basic(self):
        """Test ErrorType enum basic values."""
        # Test client errors
...
class TestErrorDetails:
    ...
    def test_error_details_creation_simple(self):
...
class TestRaisePokemonScannerError:
    ...
    def test_raise_pokemon_scanner_error_basic(self):
...
class TestHandleUnexpectedError:
    ...
    def test_handle_unexpected_error_basic(self):
...
class TestUtilityFunctions:
    ...
    def test_is_client_error_basic(self):
    ...
    def test_is_client_error_extended(self):
    ...
    def test_is_server_error_basic(self):
    ...
    def test_is_server_error_extended(self):
    ...
    def test_should_retry_extended(self):
    ...
    def test_get_retry_delay_basic(self):
    ...
    def test_get_retry_delay_extended(self):
